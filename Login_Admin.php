...
<div class="content">
<h1 class="judul">Admin Log In</h1>
    <div class="container">
<form method="post">
  ...
  if(isset($_POST['login'])){
    if(strlen($_POST['username'])){
      if(strlen($_POST['password'])){
        ...
        $query = "SELECT * FROM admin WHERE id_admin='$username' OR email_admin='$username'";
        ...
        if(!empty($data)){
          if(password_verify($_POST['password'],$data['password_admin'])){
            ...
            header("Location: CUD_Submateri.php");
          }
          else{
...
?>
  ...
  <form action="Sinkronisasi_Email_Admin.php">
