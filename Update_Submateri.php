<?php
  ...
  $query = "SELECT * FROM submateri WHERE kode_submateri='".$_GET['id']."'";
...
<div class="content">
    <h1 class="judul">Update Submateri</h2>
        <div class="container">
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    <label for="">Kode Submateri</label>
                    <input type="text" class="form-control" id="" name="kode_submateri" aria-describedby="" value="<?php echo $data['kode_submateri'];?>" disabled>
                    <input type="hidden" class="form-control" id="" name="kode_submateri" aria-describedby="" value="<?php echo $data['kode_submateri'];?>">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_submateri" id="" aria-describedby="" value="<?php echo $data['nama_submateri'];?>">
                </div>
                <div class="form-group">
                    <label for="">Isi materi</label>
                    <textarea class="form-control ckeditor" id="exampleFormControlTextarea1" rows="7" placeholder="" name="isi_submateri"><?php echo $data['isi_submateri'];?></textarea>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Gambar</label>
                    <input type="file" class="form-control" id="" aria-describedby="" name="image" value="<?php echo base64_encode($data['gbr_submateri']); ?>">
                </div>
                <br></br>
      ...
      if(strlen($_POST['kode_submateri'])>=6){
        if(strlen($_POST['nama_submateri'])){
          if(strlen($_POST['isi_submateri'])){
            ...
            $update = mysqli_query($kon, "UPDATE `submateri` SET `kode_submateri`='".$_POST['kode_submateri']."', `nama_submateri`='".$_POST['nama_submateri']."',
                       `isi_submateri`='".$_POST['isi_submateri']."', `gbr_submateri`='$imgContent', `kode_materi`='$kodeMateri', 
                       `id_admin`='".$_SESSION['adminn']."' WHERE `kode_submateri`='".$_POST['kode_submateri']."'");
